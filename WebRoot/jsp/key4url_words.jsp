...
<div id="maindiv" class="maindivelse">  
	<span class="linktextbutton">
		<span>当前的位置：系统管理&nbsp;\&nbsp;系统配置&nbsp;\&nbsp;关键字连接设置</span>
	</span>
			...
			<div>	
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr class="userlist">
						...
						<input type="text" id="channel_path" maxlength="20" value="key4url.properties" disabled="disabled"></input>
					</td>
	...
	<div id="cu_channel" class="viewfirst">
		...
		<b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
			<div class="keyboardsecond">
				<span class="span_title">文件内容<font color="red">（一行代表一个关键字，具体格式：key=url）</font></span>
				<div>
					<span class="spanthree"></span>
	...
	<!--submitbutton begin-->
        	<span><input type="submit" value="修改" 	onclick="editWords('key4url');" class="submitbutton" ></input></span>
	<!--submitbutton end-->
</div>
<!--maindiv end-->