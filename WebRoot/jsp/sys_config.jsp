			...
			<div class="keyboardfirst" onmouseout="KeyboardShowFirst(this);" onmouseover="KeyboardShowSecond(this);">
				...
				<div>
					...
					<table border="0px" cellpadding="0px" cellspacing="0px" width="100%">
						...
						<tr class="tablelist" onmouseout="showThisLinkOut(this);" onmouseover="showThisLinkOver(this);">
							<td class="tablelisttext3ro">文章关键字对应连接</td>
							<td class="tablelisttext3ro"><%=InitServlet.KEY4URLSTYLE %></td>
							<td class="tablelisttext3ro"><a href="#" onclick="showUpdateSys(this);" id="KEY4URLSTYLE " name="<%=InitServlet.KEY4URLSTYLE %>" title="文章关键字对应连接">修改</a></td>						
						</tr>
					</table>
					<!-- system config end -->
				</div>
