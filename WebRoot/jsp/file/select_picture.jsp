...
<title>赤峰聚和蒙脱石有限公司——后台管理</title>
<meta content="赤峰聚和蒙脱石有限公司——后台管理" name="keywords" />
<meta content="赤峰聚和蒙脱石有限公司——后台管理" name="description" />
...
<div id="maindiv" class="maindivelse">  
	...
	<b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
		<div class="keyboardfirst" onmouseout="KeyboardShowFirst(this);" onmouseover="KeyboardShowSecond(this);">
			...
			<span class="span_select_center">当前路径：当前路径：&lt;cms:webroot/&gt;<%=Constant.UPLOAD_PATH+"/"+userInfo.getName()+"/image"+path%>
