...
<div id="maindiv" class="maindivelse">
	...
	<span class="welcomeimagefirst" onmouseout="className='welcomeimagefirst';" onmouseover="className='welcomeimagesecond';" title="模板标签代码参考">
	</span><div><strong class="black">模板标签代码参考</strong></div></a>
				...
				<div>
					...
					<table border="0px" cellpadding="0px" cellspacing="0px" width="100%">
						...
						<tr class="tablelist" onmouseout="showThisLinkOut(this);" onmouseover="showThisLinkOver(this);">
					        <td class="tablelisttext3ro" style="text-align:right;">程序版本：</td>
					        <td class="tablelisttext3ro">1.0.8</td>
						</tr>
						<tr class="tablelist" onmouseout="showThisLinkOut(this);" onmouseover="showThisLinkOver(this);">
